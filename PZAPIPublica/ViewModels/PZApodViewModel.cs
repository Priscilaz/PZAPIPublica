...
namespace PZAPIPublica.ViewModels
{

        public class PZApodViewModel : INotifyPropertyChanged
        {
                ...
                private DateTime dateTime;
                 ...
                 public DateTime ChosenDate
                    ...
                    private PZApodService service;
                    public PZApodService Service
                    {
                        get
                        {
                            if (service == null)
                            {
                                service = new PZApodService();
                            }
                            return service;
                        }
                    }
                    ...
                    {
                        PZApod dto = await Service.GetImage(day);
                        if (dto == null)
                        {
